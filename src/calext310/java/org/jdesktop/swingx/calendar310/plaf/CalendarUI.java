 ...
 */
package org.jdesktop.swingx.calendar310.plaf;
...
public abstract class CalendarUI extends ComponentUI {
     ...
     *   
     */ 
    public abstract LocalDateTime getCellAtLocation(int x, int y);
     ...
     */
    public abstract LocalDateTime getCell(int row, int column);
     ...
     * @return
     */
    public abstract LocalDateTime getStartOfPage();
     ...
     * 
     * Note: this may differ from the columnCount of the navigator if the
     * ui decides to add a rowHeader.
     * 
     * @return
     */
     ...
     * 
     * Note: this may differ from the rowCount of the navigator if the
     * ui decides to add a columnHeader.
     * 
     * @return
     */
     ...
     */
    public abstract LocalDateTime getLead();
     ...
     */
    public abstract CellState getCellState(int row, int column);
