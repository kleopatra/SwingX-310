/*
 * $Id: MonthViewUI.java 3220 2010-01-20 12:18:36Z kleopatra $
 *
...
//    public abstract String[] getDaysOfTheWeek();
    ...
    public abstract Map<DayOfWeek, String> getDaysOfTheWeekTexts();
     ...
     */ 
    public abstract LocalDateTime getDayAtLocation(int x, int y);
     ...
     */
    public abstract LocalDateTime getLastDisplayedDay();
