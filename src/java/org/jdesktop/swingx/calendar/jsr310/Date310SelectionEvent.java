/*
 * $Id: Date310SelectionEvent.java 2963 2009-01-12 19:35:21Z kleopatra $
 *
 ...
 */
public class Date310SelectionEvent extends EventObject {
     ...
     */
    public Date310SelectionEvent(Object source, EventType eventType, boolean adjusting) {
        super(source);
    ...
    public SortedSet<LocalDateTime> getSelection() {
        return ((Date310SelectionModel)source).getSelection();
    }
