 ...
 */
public class DatePickerFormatter310 extends
        JFormattedTextField.AbstractFormatter {
    
    private static final Logger LOG = Logger
            .getLogger(DatePickerFormatter310.class.getName());
    private Format _formats[] = null;
     ...
     *   null formats.
     */
    public DatePickerFormatter310(Format formats[]) {
        this(formats, null);
    }
     ...
     */
    public DatePickerFormatter310(Locale locale) {
        this(null, locale);
    }
     ...
     * @param locale
     */
    public DatePickerFormatter310(Format formats[], Locale locale) {
//        super();
        if (locale == null) {
    ...
    public Format[] getFormats() {
        Format[] results = new Format[_formats.length];
    ...
    public Object stringToValue(String text) throws ParseException {
        ...
        // in.
        for (Format _format : _formats) {
            try {
                result = (_format).parseObject(text);
                pex = null;
                break;
     ...
     */
    protected Format[] createDefaultFormats(Locale locale) {
        List<Format> f = new ArrayList<Format>();
        ...
        return f.toArray(new Format[f.size()]);
    }
     ...
     */
    private void addSystemDefaultFormat(List<Format> f, Locale locale) {
//        f.add(DateFormat.getDateInstance(DateFormat.SHORT, locale));
     ...
     */
    private void addFormat(List<Format> f, String key, Locale locale) {
     ...
     */
    public static class DatePickerFormatterUIResource extends DatePickerFormatter310 
